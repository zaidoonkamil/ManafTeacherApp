                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap:()async{
                                      final url =
                                          'https://www.instagram.com/munaf_alkritti?igsh=MWhnaG80cHo3a3ptcg==';
                                      await launch(
                                        url,
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                Image.asset('assets/images/Group 1171275618 (3).png'),
                                              ],
                                            ),
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: 4,),
                                                Image.asset('assets/images/lucide_instagram (1).png'),
                                              ],
                                            ),
                                          ],
                                        ),
                                  ...
                                  GestureDetector(
                                    onTap:()async{
                                      final url =
                                          'https://www.facebook.com/share/1AbAsx1WBN/?mibextid=wwXIfr';
                                      await launch(
                                        url,
                                        enableJavaScript: true,
                                      ).catchError((e) {
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                Image.asset('assets/images/Group 1171275618 (4).png'),
                                              ],
                                            ),
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: 4,),
                                                Image.asset('assets/images/circum_facebook.png'),
                                              ],
                                            ),
                                          ],
                                        ),
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: 4,),
                                                Image.asset('assets/images/hugeicons_telegram.png'),
                                              ],
                                            ),
                                          ],
                                        ),
